...
const IngredientRow = ({ prep, ingredient, prepIndex, ingredientIndex }) => {
  ...
  return (
    <TableRow>
        ...
        return (
          <React.Fragment key={procKey}>
            <TableCell className="font-mono capitalize">
              <Input value={initialWeight} onChange={e => updateField(proc.fields[0], e.target.value)} className="w-24 text-center font-mono capitalize" />
            </TableCell>
            <TableCell className="font-mono capitalize">
              <Input value={finalWeight} onChange={e => updateField(proc.fields[1], e.target.value)} className="w-24 text-center font-mono capitalize" />
            </TableCell>
      ...
      <TableCell className="text-center font-bold font-mono capitalize"><span className="text-slate-700">{formatPercentage(getYield(ingredient))}</span></TableCell>
