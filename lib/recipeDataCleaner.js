...
export function logCleaningResults(original, cleaned) {
  if (process.env.NODE_ENV === 'development') {
    console.group('🧹 Limpeza de Dados da Receita');
    console.log('📄 Dados originais:', original);
    console.log('✨ Dados limpos:', cleaned);
    console.log('📊 Preparações limpas:', cleaned.preparations?.length || 0);
    console.log('🥬 Total de ingredientes:', cleaned.preparations?.reduce((total, prep) => 
